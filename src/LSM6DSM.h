...
class LSM6DSM
{
    ...
    private:
        ...
        static bool rangeTest(int16_t ptestvals[3], int16_t ntestvals[3], int16_t nomvals[3], float res, float minval, float maxval);

        static bool outOfRange(float val, float minval, float maxval);
